...
for nca in [40]:#[10,30,50,70,90,100,110,130,150,170,190]:
	for dirnr in range(1):
		mpclist = [250,250]#[400,800]#
		...
		with open(outpath+'head','w') as of:
			...
			of.write(str(int(nca)*(mpclist[0]-1)+int(nc-nca)*(mpclist[1]-1))+' bonds\n')
			of.write(str(int(nca)*(mpclist[1]-2)+int(nc-nca)*(mpclist[1]-2))+' angles\n')
			of.write('\n')
